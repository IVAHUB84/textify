...
**Выдача результата:**
- **Личка:** сначала суть (1–2 предложения) + кнопки «Показать полностью» (`act:full`) и «Кратко» (`act:sum`); полный текст доступен по кнопке.
- **Группы:** полный структурированный текст + одна кнопка «Кратко» (`act:sum`).

**Inline-действия:**
- «Показать полностью» (`act:full`) — личка: раскрывает полный структурированный текст.
- «Кратко» (`act:sum`) — личка и группы: краткое изложение (1–2 абзаца).
