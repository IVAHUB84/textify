...
START_TEXT = (
    "Привет! Я Textify — превращаю голос, аудио, видео и изображения в чистый текст.\n\n"
    "Что умею:\n"
    "• Голос и аудио → транскрипт. Кнопками: ⏱ Тайм-коды и Субтитры (.srt).\n"
    "• Видео, кружочки и видео-файлы → распознаю речь из видео.\n"
...
BOT_DESCRIPTION = (
    ...
    "• Голос, аудио и видео → транскрипт (+ тайм-коды и субтитры .srt)\n"
    "• Фото и сканы → текст (OCR), searchable PDF или скан ч/б\n"
    "• Кратко, перевод RU↔EN и «Задачи» одной кнопкой\n"
    "• Работает и в группах\n\n"
    "Отправьте голос, видео или фото — верну чистый текст."
)

# Short description — карточка профиля бота, лимит 120 символов.
BOT_SHORT_DESCRIPTION = (
    "Голос, видео и фото → текст в Telegram. OCR, PDF, перевод RU↔EN, субтитры. Бесплатно."
)
...
HELP_TEXT = (
    ...
    "• Видео — пришлите видео, кружочек или видео-файл, распознаю речь из звуковой "
    "дорожки (не текст в кадре).\n"
